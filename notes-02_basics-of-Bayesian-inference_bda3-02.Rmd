...
- BDA3 chapter 2 and [reading instructions](`r paste0(CM_URL, "BDA3_ch02_reading-instructions.pdf")`)
- lectures:
...
- [slides](`r paste0(CM_URL, "slides_ch2.pdf")`) and [extra slides](`r paste0(CM_URL, "slides_ch2_extra1.pdf")`)
