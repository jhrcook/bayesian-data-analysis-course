...
The original code is available in the GitHub repo ["models"](`r MODELS_URL`) directory and they are also copied in the [Models](#stan-models-1) section of this website.

- [Drug bioassay model](`r paste0(MODELS_URL, "assignment06-bioassay.stan")`) for Assignment 6
- [8 school SAT model](`r paste0(MODELS_URL, "8-schools.stan")`)
- [Drownings](`r paste0(MODELS_URL, "assignment07-drownings.stan")`) for Assignment 7
- Factory machine measurements for Assignments 7 & 8:
  - [pooled](`r paste0(MODELS_URL, "assignment07_factories_pooled.stan")`)
  - [separate](`r paste0(MODELS_URL, "assignment07_factories_separate.stan")`)
  - [hierarchical](`r paste0(MODELS_URL, "assignment07_factories_hierarchical.stan")`) (also used in Assignment 9)
- [serial dilution assay](`r paste0(MODELS_URL, "serial-dilution.stan")`) for chapter 19 exercises
