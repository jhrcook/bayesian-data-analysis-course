...
- BDA3 chapter 10 and [reading instructions](`r paste0(CM_URL, "BDA3_ch10_reading-instructions.pdf")`)
- lectures:
...
- [slides](`r paste0(CM_URL, "slides_ch10.pdf")`)
- [Assignment 1](`r paste0(CM_URL, "assignment-04.pdf")`)
