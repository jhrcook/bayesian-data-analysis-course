...
- reading:
  - BDA3 ch. 6 "Model checking" and [ch. 6 reading instructions](`r paste0(CM_URL, "BDA3_ch06_reading-instructions.pdf")`)
  ...
  - read *Visualization in Bayesian workflow* ([pdf](`r paste0(READING_URL, "Visualization-in-Bayesian-workflow.pdf")`), [link](https://doi.org/10.1111/rssa.12378))
  - read *Practical Bayesian model evaluation using leave-one-out cross-validation and WAIC* ([pdf](`r paste0(CM_URL, "Practical-Bayesian-model-evaluation-using-leave-one-out-cross-validation-and-WAIC.pdf")`), [link](https://arxiv.org/abs/1507.04544))
...
- slides:
  - [ch 6 slides](`r paste0(CM_URL, "slides_ch6.pdf")`)
  - [ch 7 slides](`r paste0(CM_URL, "slides_ch7.pdf")`)
...
([pdf](`r paste0(READING_URL, "Visualization-in-Bayesian-workflow.pdf")`), [link](https://doi.org/10.1111/rssa.12378))
...
([pdf](`r paste0(READING_URL, "Practical-Bayesian-model-evaluation-using-leave-one-out-cross-validation-and-WAIC.pdf")`), [link](https://arxiv.org/abs/1507.04544))
