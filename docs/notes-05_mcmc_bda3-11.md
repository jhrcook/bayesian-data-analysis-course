...
- Outline of the chapter 11
  ...
  - 11.2 Metropolis and Metropolis-Hastings (an example of simple MCMC method) • 11.3 Using Gibbs and Metropolis as building blocks (can be skipped)
...
![Rhat-with-few-draws](assets/05_mcmc_bda3-11/slides_ch11-s28-1.png)

![Rhat-with-many-draws](assets/05_mcmc_bda3-11/slides_ch11-s28-3.png)
...
![autocorrelation-example](assets/05_mcmc_bda3-11/slides_ch11-s36.png)
