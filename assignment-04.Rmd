...
**[Assignment 4](`r paste0(CM_URL, "assignment-04.pdf")`)**
...
We can see that even though there were 4000 draws, the effective sampling size is about `r round(prior_s_eff)`.
